...
export default function App() {
  ...
  return <div className="flex h-screen overflow-hidden bg-background text-foreground">
    ...
    <section className="relative flex min-w-0 flex-1 flex-col">
      <Toolbar onAi={() => setAiOpen(true)} onPlugins={() => setPluginsOpen(true)} onSettings={() => setSettingsOpen(true)} onToggleSidebar={() => setSidebarOpen((open) => !open)} sidebarOpen={sidebarOpen} />
