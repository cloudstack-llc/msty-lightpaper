...
const api = {
  ...
  listExternalPluginBundles: () => ipcRenderer.invoke('plugins:externalBundles'),
  installSamplePlugin: (id: string) => ipcRenderer.invoke('plugins:installSample', id),
  installLocalPlugin: (pluginPath?: string) => ipcRenderer.invoke('plugins:installLocal', pluginPath),
